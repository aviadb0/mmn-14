...
const Op operationsTable[] = {
	{ MOV_OPERATION, 2, ADDRESSING_ALL, MEMORY_REGISTER_MATRIX, 0 },
	{ CMP_OPERATION, 2, ADDRESSING_ALL, ADDRESSING_ALL, 1 },
	{ ADD_OPERATION, 2, ADDRESSING_ALL, MEMORY_REGISTER_MATRIX, 2 },
	{ SUB_OPERATION, 2, ADDRESSING_ALL, MEMORY_REGISTER_MATRIX, 3 },
	{ NOT_OPERATION, 1, ADDRESSING_NONE, MEMORY_REGISTER_MATRIX, 4 },
	{ CLR_OPERATION, 1, ADDRESSING_NONE, MEMORY_REGISTER_MATRIX, 5 },
	{ LEA_OPERATION, 2, memory | matrix, MEMORY_REGISTER_MATRIX, 6 },
	{ INC_OPERATION, 1, ADDRESSING_NONE, MEMORY_REGISTER_MATRIX, 7 },
	{ DEC_OPERATION, 1, ADDRESSING_NONE, MEMORY_REGISTER_MATRIX, 8 },
	{ JMP_OPERATION, 1, ADDRESSING_NONE, MEMORY_REGISTER_MATRIX, 9 },
	{ BNE_OPERATION, 1, ADDRESSING_NONE, MEMORY_REGISTER_MATRIX, 10 },
	{ RED_OPERATION, 1, ADDRESSING_NONE, MEMORY_REGISTER_MATRIX, 11 },
	{ PRN_OPERATION, 1, ADDRESSING_NONE, ADDRESSING_ALL, 12 },
	{ JSR_OPERATION, 1, ADDRESSING_NONE, MEMORY_REGISTER_MATRIX, 13 },
